...
import { createNewCourse, createNewLink, deleteCourse, deleteLink, getAdminCourses, getBannedUsers, getCourseLinks, getNotBannedUsers, getPlans, updateCourseInformation, updateLinkInformation } from './utils/fetchs';
